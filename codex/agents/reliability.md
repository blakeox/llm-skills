...
> Reliability and operability specialist. Focuses on failure handling, observability, retries, backpressure, alerting, queues, timeouts, degradation, and recovery behavior under real production conditions. Use for incident-prone flows, background jobs, distributed systems, and anything that must keep working when reality gets messy.
