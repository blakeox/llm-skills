...
> Orchestrated product design critic. Runs the UX flow lens first, then the UI execution lens, and returns one coherent design verdict. Use when reviewing a feature from both product-flow and interface-quality perspectives.
