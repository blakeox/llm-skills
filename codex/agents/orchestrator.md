...
> Meta-agent that decides whether a task should stay single-agent or fan out to a fleet-style specialist team. Use for multi-surface work spanning product, architecture, design, implementation, testing, API, delivery, or post-incident analysis.
