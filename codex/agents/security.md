...
> Security and trust-boundary specialist. Hunts auth gaps, privilege escalation, data exposure, injection, secret handling mistakes, and abuse paths with a first-principles, exploit-minded lens. Use for exposed surfaces, auth changes, admin flows, uploads, and anything attackers or careless operators could abuse.
