...
> Latency, throughput, memory, and scaling specialist. Finds the slow paths, hidden N+1s, fan-out costs, unbounded work, and tail-latency traps that only show up under real load. Use for hot endpoints, expensive screens, background jobs, batch work, and systems expected to scale.
